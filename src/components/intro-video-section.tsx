              ...
              {!isPlaying ? (
                ...
                <div className="relative aspect-video cursor-pointer" onClick={() => setIsPlaying(true)}>
                  ...
                  {thumbnailUrl ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-slate-800 via-slate-900 to-black relative overflow-hidden">
                      ...
                      <div className="absolute inset-0 opacity-20">
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-emerald-500/30 via-green-500/30 to-teal-300/30 animate-gradient bg-[length:200%_200%]"></div>
                      </div>
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-center justify-center group/play">
                    ...
                    >
                      {/* Play Button Glow */}
                      <div className="absolute inset-0 bg-emerald-500 rounded-full blur-2xl opacity-60 group-hover/play:opacity-100 transition-opacity"></div>

                      {/* Play Button */}
                      <div className="relative w-20 h-20 md:w-24 md:h-24 bg-gradient-to-br from-emerald-500 to-green-600 rounded-full flex items-center justify-center shadow-2xl border-4 border-white/20 group-hover/play:border-white/40 transition-all">
