...
const skillCategories = [
  {
    ...
    icon: Code2,
    skills: [
      { name: "React.js", years: "4+ years", level: "Expert" as const },
      { name: "Next.js (SSR, ISR, RSC)", years: "3+ years", level: "Expert" as const },
      { name: "TypeScript", years: "3+ years", level: "Advanced" as const },
  ...
  },
  {
    ...
    icon: Palette,
    skills: [
      { name: "Tailwind CSS", years: "3+ years", level: "Expert" as const },
      { name: "SASS/SCSS", years: "4+ years", level: "Advanced" as const },
      { name: "CSS3/Responsive", years: "5+ years", level: "Expert" as const },
      { name: "shadcn/ui", years: "1+ year", level: "Advanced" as const },
    ],
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "MySQL/PostgreSQL", years: "3+ years", level: "Intermediate" as const },
